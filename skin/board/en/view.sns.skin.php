...
<h3>공유하기</h3>
<ul>
    <li><a href="<?php echo $facebook_url; ?>" target="_blank" class="sns_f"><i class="fab fa-facebook-f"></i><span class="sound_only">페이스북으로 보내기</span></a></li>
    <li><a href="<?php echo $gplus_url; ?>" target="_blank" class="sns_g"><i class="fab fa-twitter"></i><span class="sound_only">구글플러스로 보내기</span></a></li>
    <li><a href="<?php echo $twitter_url; ?>" target="_blank" class="sns_t"><i class="fab fa-google"></i><span class="sound_only">트위터로 보내기</span></a></li>
    <?php if($config['cf_kakao_js_apikey']) { ?>
