...
<table width="<?=$width?>" align="center" cellpadding="0" cellspacing="0"><tr><td>
    ...
    <tr>
        ...
        <th>시 험 명</th>
        <th><?=subject_sort_link('wr_name', $qstr2, 1)?>이름</a></th>
        <th><?=subject_sort_link('wr_datetime', $qstr2, 1)?>시험날짜</a></th>
        <th><?=subject_sort_link('wr_good', $qstr2, 1)?>점수</a></th>
...
//echo $list[$i][num];
        ...
        <td class="name" align=center><?=$list[$i][wr_name]?></td>
        <td  align=center><?=$list[$i][datetime2]?></td>
        <td  align=center><?=$list[$i][wr_good]?>점&nbsp;</td>
