...
<div id="mb_login" class="mbskin">
    <div class="mbskin_logo">
        <a href="<?php echo G5_URL ?>"><img src="../theme/gicertorg/skin/member/basic/img/logo_login.png" alt="gicertorg"></a>
    </div>
        ...
        <fieldset id="login_fs">
            ...
            <div id="login_info">
                ...
                <div class="login_if_lpl">
                    <a href="<?php echo G5_BBS_URL ?>/password_lost.php" target="_blank" id="login_password_lost">Forgot password?</a>  
                </div>
            </div>
        </fieldset> 
        </form>
    ...
    <div class="mbskin_copy">
        <p>Copyright © 2017 GIC Global Inter Certification All Rights Reserved.</p>
    </div>
</div>
